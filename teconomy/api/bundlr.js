...
var Bundlr = /** @class */ (function () {
    function Bundlr() {
        return;
    }
    Bundlr.prototype.withdrawBalance = function (amount) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, withdrawal_1.withdrawBalance)(this.utils, this.api, amount)];
     ...
     */
    Bundlr.prototype.getLoadedBalance = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.utils.getBalance(this.address)];
            });
        });
    };
    /**
     ...
     */
    Bundlr.prototype.getBalance = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.utils.getBalance(address)];
            });
        });
    };
    /**
     ...
     */
    Bundlr.prototype.fund = function (amount, multiplier) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.funder.fund(amount, multiplier)];
            });
        });
    };
    /**
     ...
     * @returns
     */
    Bundlr.prototype.getPrice = function (bytes) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.utils.getPrice(this.currency, bytes)];
            });
        });
    };
    /**
